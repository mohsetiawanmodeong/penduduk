					...
					<table class="table table-bordered table-striped table-hover table-saya">
						...
						<tbody>
							...
							<tr>
								...
								<td>
									<a href="desa_edit.php?id=<?php echo $d['desa_id']; ?>" class="btn btn-warning text-white btn-sm"><i class="fa fa-wrench"></i></a>
									<a href="desa_hapus.php?id=<?php echo $d['desa_id']; ?>" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i></a>
								</td>
							</tr>
							<?php 
							}
